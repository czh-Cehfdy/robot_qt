...
//    void recieveJsMessage(std_msgs::String x1,std_msgs::String y1,std_msgs::String x2,std_msgs::String y2);
    void recieveJsMessage(const QString& np,const QString& path_points);
//    void recieveJsMessage(const QJsonValue &other);
...
private:
    ...
    QNode qnode_GetStartPoint;
    QNode qnode_raw_image;
    QNode qnode_fusion_image;
    QNode qnode_pcl_image;
    QNode qnode_points;
    QNode qnode_sonar;
    QNode qnode_obstacle;
    QNode rostopic_list;
    QNode qnode_Get_gps;
    QNode* PTR_;
    ...
    QWebChannel *m_GetSPWebChannel = nullptr;
